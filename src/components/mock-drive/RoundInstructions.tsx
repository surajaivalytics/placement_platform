...
export function RoundInstructions({ round, onStart }: RoundInstructionsProps) {
            ...
            <Card className="max-w-4xl w-full shadow-lg border-t-4 border-t-[#181C2E]">
                <div className="p-6 md:p-8 space-y-6">
                    ...
                    <div className="border-b border-gray-200 pb-4">
                        <h1 className="text-2xl font-bold text-[#181C2E] text-center">{round?.title || "Round Assessment"}</h1>
                        <p className="text-gray-500 mt-1 text-center">{round?.description || "Round Guidelines & Instructions"}</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="bg-red-50/50 p-4 rounded-lg border border-red-100 flex flex-col items-center text-center gap-2">
                            ...
                            <p className="text-xs text-gray-600">Switching tabs or minimizing window will terminate the round.</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar bg-gray-50 p-4 rounded-lg border border-gray-200">
                        ...
                        <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700">
                            <li>This round consists of strict time limits.</li>
