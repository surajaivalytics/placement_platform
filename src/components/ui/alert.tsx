...
const alertVariants = cva(
  "relative w-full rounded-none border p-5 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-5 [&>svg]:top-5 [&>svg]:text-foreground shadow-sm transition-all duration-300",
  {
    variants: {
      variant: {
