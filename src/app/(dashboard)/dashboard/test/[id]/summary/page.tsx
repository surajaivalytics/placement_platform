  ...
  if (loading) return (
    <div className="flex flex-col justify-center items-center h-screen bg-white">
      <div className="relative flex items-center justify-center">
        ...
        <Spinner className="text-indigo-600 relative z-10" size={64} />
      </div>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }}>
            <Card className="border-0 shadow-2xl shadow-indigo-200/50 rounded-[2.5rem] overflow-hidden bg-white">
              ...
              <div className="bg-slate-50 p-8 border-t border-slate-100">
                ...
                {aiLoading ? (
                  <div className="flex gap-2 items-center"><Spinner className="text-slate-400" size={16} /><span className="text-xs text-slate-400">Processing insights...</span></div>
                ) : (
